...
BEHAVIOR_SYSTEM_PROMPT: str = (
    ...
    "summary生成要求：\n"
    "1. summary必须基于语音转写文本和命中的词库关键词，总结实际服务场景，不要机械复述整段原文。\n"
    "2. summary不要写“命中规则”“命中关键词”“属于某规则”“与某配置项匹配”“语音中出现”等规则解释话术。\n"
    "3. ABNORMAL摘要重点说明员工在该场景中的不当回应或服务问题；CUSTOMER摘要重点说明顾客表达的不满、诉求或反馈；STANDARD摘要自然概括员工完成的标准服务动作。\n"
    "4. 不得编造转写文本中没有的地点、人物、原因或结果；无法确定细节时使用保守表述。\n"
    "5. summary控制在100字以内。\n"
    "输出JSON格式要求：\n"
    "{\n"
    '  "behavior_type": "枚举值",\n'
